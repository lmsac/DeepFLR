...
########
pdeep2=pd.read_json(args.pdeep2jsonfile)
...
def ions(row):
    ...
    return ions
pdeep2["_ions"]=pdeep2.apply(ions,axis=1)
pdeep2["_key"]=pdeep2.apply(modification2key,axis=1)
...
pdeep2["score"].to_csv("pdeep2testresult.csv",index=False)